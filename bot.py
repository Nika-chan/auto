...
def quote():
    u = requests.get("https://gist.githubusercontent.com/Nika-chan/4d8812307d66087b18574635fa01ae97/raw/0fa6e1abf2170f761c5c343873543c54e0f22254/fishing.json").json()
